...
export function Header() {
  ...
  return (
    <header 
      className="no-print fixed top-0 left-0 right-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur-sm"
    ...
    >
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          <div className="container mx-auto max-w-7xl px-4 py-3 border-b border-border/40">
            <UpdateBadge />
          </div>
