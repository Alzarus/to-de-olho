            ...
            {BRAZIL_STATES.map((state) => {
                ...
                return (
                  <Tooltip key={state.id}>
                    <TooltipTrigger asChild>
                      <path
                        ...
                        className={cn(
                          ...
                          hasData 
                            ? "fill-blue-600 dark:fill-blue-500 hover:opacity-80" 
                            : "fill-gray-200 dark:fill-gray-800 hover:fill-gray-300 dark:hover:fill-gray-700" 
                        )}
                    ...
                    <TooltipContent>
                      <div className="text-sm font-medium">{state.name} ({state.id})</div>
                      {formattedValue && <div className="text-xs font-medium opacity-90">{formattedValue}</div>}
                    </TooltipContent>
                  </Tooltip>
                );
            })}
